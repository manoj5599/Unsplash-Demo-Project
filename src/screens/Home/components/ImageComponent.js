  ...
  return (
    <div className="container">
      <div className="image-container">
        ...
        <img
          alt={"Demo pic"}
          src={`https://images.unsplash.com/photo-1659846960718-aab68e05fdc9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1vZi10aGUtZGF5fHx8fGVufDB8fHx8&dpr=2&auto=format%2Ccompress&fit=crop&w=1399&h=594`}
          width="100%"
        />
